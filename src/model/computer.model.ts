...
export const keysOfComputer = [
    ...
    {name: "type", type: "select", options: ["Notebook", "Desktop"]},
    {name: "brand", type: "select", options: ["Apple", "Microsoft", "Dell", "HP", "Lenovo", "Acer", "Asus", "Samsung", "LG", "Sony", "Toshiba", "MSI", "Razer", "Alienware", "Gigabyte", "Huawei", "Xiaomi"]},
    ...
    {name: "ram", type: "select", options: ["2GB", "4GB", "8GB", "16GB", "32GB", "64GB", "128GB", "256GB", "512GB", "1TB", "2TB", "4TB", "8TB", "16TB"]},
    ...
    {name: "operatingSystem", type: "select", options: ["Windows", "macOS", "Linux", "Chrome OS"]},
...
export const storageFields = [
    {name: "ssd", type: "select", options: ["128GB", "256GB", "512GB", "1TB", "2TB", "4TB", "8TB", "16TB"]},
    {name: "hdd", type: "select", options: ["128GB", "256GB", "512GB", "1TB", "2TB", "4TB", "8TB", "16TB"]},
]
