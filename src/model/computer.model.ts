...
export const computerBrands = ["Apple", "Microsoft", "Dell", "HP", "Lenovo", "Acer", "Asus", "Samsung", "LG", "Sony", "Toshiba", "MSI", "Razer", "Alienware", "Gigabyte", "Huawei", "Xiaomi"];
export const computerTypes = ["Notebook", "Desktop"];
export const processors = ["Apple M1", "Intel Core i9", "Intel Core i7", "Intel Core i5", "Intel Core i3", "Intel Xeon", "AMD Ryzen 9", "AMD Ryzen 7", "AMD Ryzen 5", "AMD Ryzen 3", "AMD Athlon", "AMD A-Series", "AMD FX-Series", "AMD E-Series", "AMD C-Series", "Qualcomm Snapdragon", "MediaTek Helio", "Samsung Exynos", "Nvidia Tegra", "Rockchip RK", "Allwinner A", "Amlogic S", "Broadcom BCM", "Marvell Armada", "HiSilicon Kirin", "Spreadtrum SC", "Unisoc Tiger", "VIA Nano", "Vortex86", "Zilog Z80", "Other"];
export const ramOptions = ["2GB", "4GB", "8GB", "16GB", "32GB", "64GB", "128GB", "256GB", "512GB", "1TB", "2TB", "4TB", "8TB", "16TB"];
...
export const operatingSystems = ["Windows", "macOS", "Linux", "Chrome OS"];

export const keysOfComputer = [
    {name: "title", type: "string", required: true},
    {name: "type", type: "select", options: computerTypes, required: true},
    {name: "brand", type: "select", options: computerBrands, required: true},
    ...
    {name: "graphicsCard", type: "select",
        options: graphicsCards, required: false},
